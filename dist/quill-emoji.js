...
/* harmony default export */ var emoji_list = (emojiList);
// CONCATENATED MODULE: ./src/emoji-map.js

var emojiMap = {};
emoji_list.forEach(function (emojiListObject) {
  emojiMap[emojiListObject.name] = emojiListObject;
});
/* harmony default export */ var emoji_map = (emojiMap);
...
var Embed = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('blots/embed');

var format_emoji_blot_EmojiBlot =
/*#__PURE__*/
function (_Embed) {
...
format_emoji_blot_EmojiBlot.blotName = 'emoji';
format_emoji_blot_EmojiBlot.className = 'ql-emojiblot';
format_emoji_blot_EmojiBlot.tagName = 'span';
format_emoji_blot_EmojiBlot.emojiClass = 'ap';
format_emoji_blot_EmojiBlot.emojiPrefix = 'ap-';
/* harmony default export */ var format_emoji_blot = (format_emoji_blot_EmojiBlot);
// EXTERNAL MODULE: ./node_modules/fuse.js/dist/fuse.js
var dist_fuse = __webpack_require__(1);
var fuse_default = /*#__PURE__*/__webpack_require__.n(dist_fuse);

// CONCATENATED MODULE: ./src/module-emoji.js
function module_emoji_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { module_emoji_typeof = function _typeof(obj) { return typeof obj; }; } else { module_emoji_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return module_emoji_typeof(obj); }

function module_emoji_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function module_emoji_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function module_emoji_createClass(Constructor, protoProps, staticProps) { if (protoProps) module_emoji_defineProperties(Constructor.prototype, protoProps); if (staticProps) module_emoji_defineProperties(Constructor, staticProps); return Constructor; }

function module_emoji_possibleConstructorReturn(self, call) { if (call && (module_emoji_typeof(call) === "object" || typeof call === "function")) { return call; } return module_emoji_assertThisInitialized(self); }

function module_emoji_getPrototypeOf(o) { module_emoji_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return module_emoji_getPrototypeOf(o); }

function module_emoji_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function module_emoji_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) module_emoji_setPrototypeOf(subClass, superClass); }

function module_emoji_setPrototypeOf(o, p) { module_emoji_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return module_emoji_setPrototypeOf(o, p); }
...
var module_emoji_ShortNameEmoji =
/*#__PURE__*/
function (_Module) {
  module_emoji_inherits(ShortNameEmoji, _Module);

  function ShortNameEmoji(quill, options) {
    var _this;

    module_emoji_classCallCheck(this, ShortNameEmoji);

    _this = module_emoji_possibleConstructorReturn(this, module_emoji_getPrototypeOf(ShortNameEmoji).call(this, quill, options));
    _this.emojiList = options.emojiList;
    _this.fuse = new fuse_default.a(options.emojiList, options.fuse);
    _this.quill = quill;
    ...
    _this.onSelectionChange = _this.maybeUnfocus.bind(module_emoji_assertThisInitialized(_this));
    _this.onTextChange = _this.update.bind(module_emoji_assertThisInitialized(_this));
    _this.open = false;
    _this.atIndex = null;
    ...
    quill.keyboard.addBinding({
      ...
      shiftKey: true
    }, _this.triggerPicker.bind(module_emoji_assertThisInitialized(_this)));
    quill.keyboard.addBinding({
      key: 59,
    ...
    quill.keyboard.addBinding({
      ...
      // ArrowRight
      collapsed: true
    }, _this.handleArrow.bind(module_emoji_assertThisInitialized(_this)));
    quill.keyboard.addBinding({
      key: 40,
      // ArrowRight
      collapsed: true
    }, _this.handleArrow.bind(module_emoji_assertThisInitialized(_this))); // TODO: Add keybindings for Enter (13) and Tab (9) directly on the quill editor

    return _this;
  }

  module_emoji_createClass(ShortNameEmoji, [{
    key: "triggerPicker",
    value: function triggerPicker(range, context) {
      if (this.open) return true;

      if (range.length > 0) {
        this.quill.deleteText(range.index, range.length, external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.sources.USER);
      }

      this.quill.insertText(range.index, ":", "emoji-shortname", external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.sources.USER);
    ...
    key: "maybeUnfocus",
    value: function maybeUnfocus(range, oldRange, source) {
    ...
    value: function close(value) {
      ...
      if (value) {
        this.quill.deleteText(this.atIndex, this.query.length + 1 + trailingDelete, external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.sources.USER);
        this.quill.insertEmbed(this.atIndex, 'emoji', value, external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.sources.USER);
        setTimeout(function () {
...
module_emoji_ShortNameEmoji.DEFAULTS = {
...
/* harmony default export */ var module_emoji = (module_emoji_ShortNameEmoji);
// CONCATENATED MODULE: ./src/module-toolbar-emoji.js
function module_toolbar_emoji_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { module_toolbar_emoji_typeof = function _typeof(obj) { return typeof obj; }; } else { module_toolbar_emoji_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return module_toolbar_emoji_typeof(obj); }

function module_toolbar_emoji_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function module_toolbar_emoji_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function module_toolbar_emoji_createClass(Constructor, protoProps, staticProps) { if (protoProps) module_toolbar_emoji_defineProperties(Constructor.prototype, protoProps); if (staticProps) module_toolbar_emoji_defineProperties(Constructor, staticProps); return Constructor; }

function module_toolbar_emoji_possibleConstructorReturn(self, call) { if (call && (module_toolbar_emoji_typeof(call) === "object" || typeof call === "function")) { return call; } return module_toolbar_emoji_assertThisInitialized(self); }

function module_toolbar_emoji_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function module_toolbar_emoji_getPrototypeOf(o) { module_toolbar_emoji_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return module_toolbar_emoji_getPrototypeOf(o); }

function module_toolbar_emoji_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) module_toolbar_emoji_setPrototypeOf(subClass, superClass); }

function module_toolbar_emoji_setPrototypeOf(o, p) { module_toolbar_emoji_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return module_toolbar_emoji_setPrototypeOf(o, p); }




var Delta = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('delta');
var module_toolbar_emoji_Module = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('core/module');

var ToolbarEmoji =
/*#__PURE__*/
function (_Module) {
  module_toolbar_emoji_inherits(ToolbarEmoji, _Module);

  function ToolbarEmoji(quill, options) {
    var _this;

    module_toolbar_emoji_classCallCheck(this, ToolbarEmoji);

    _this = module_toolbar_emoji_possibleConstructorReturn(this, module_toolbar_emoji_getPrototypeOf(ToolbarEmoji).call(this, quill, options));
    _this.quill = quill;
  ...
  module_toolbar_emoji_createClass(ToolbarEmoji, [{
...
function fn_showEmojiPalatte(quill) {
  ...
  var editorCenter = quill.container.offsetWidth / 2;
  var editorMiddle = quill.container.offsetHeight / 2;
  var selectionCenter = (atSignBounds.left + atSignBounds.right) / 2;
  var selectionMiddle = (atSignBounds.top + atSignBounds.bottom) / 2;
...
function fn_emojiElementsToPanel(type, panel, quill) {
  ...
  var fuse = new fuse_default.a(emoji_list, fuseOptions);
  ...
  result.map(function (emoji) {
    ...
    if (customButton) {
      customButton.addEventListener('click', function () {
        var emoji_icon_html = module_toolbar_emoji_makeElement("span", {
          className: "ico",
          innerHTML: '' + emoji.code_decimal + ' '
        });
        var emoji_icon = emoji_icon_html.innerHTML;
        quill.insertEmbed(range.index, 'emoji', emoji, external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.sources.USER);
        setTimeout(function () {
...
function module_toolbar_emoji_makeElement(tag, attrs) {
  var elem = document.createElement(tag);
  Object.keys(attrs).forEach(function (key) {
    return elem[key] = attrs[key];
  });
...
/* harmony default export */ var module_toolbar_emoji = (ToolbarEmoji);
// CONCATENATED MODULE: ./src/module-textarea-emoji.js
function module_textarea_emoji_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { module_textarea_emoji_typeof = function _typeof(obj) { return typeof obj; }; } else { module_textarea_emoji_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return module_textarea_emoji_typeof(obj); }

function module_textarea_emoji_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function module_textarea_emoji_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function module_textarea_emoji_createClass(Constructor, protoProps, staticProps) { if (protoProps) module_textarea_emoji_defineProperties(Constructor.prototype, protoProps); if (staticProps) module_textarea_emoji_defineProperties(Constructor, staticProps); return Constructor; }

function module_textarea_emoji_possibleConstructorReturn(self, call) { if (call && (module_textarea_emoji_typeof(call) === "object" || typeof call === "function")) { return call; } return module_textarea_emoji_assertThisInitialized(self); }

function module_textarea_emoji_getPrototypeOf(o) { module_textarea_emoji_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return module_textarea_emoji_getPrototypeOf(o); }

function module_textarea_emoji_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function module_textarea_emoji_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) module_textarea_emoji_setPrototypeOf(subClass, superClass); }

function module_textarea_emoji_setPrototypeOf(o, p) { module_textarea_emoji_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return module_textarea_emoji_setPrototypeOf(o, p); }




var module_textarea_emoji_Delta = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('delta');
var module_textarea_emoji_Module = external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.import('core/module');

var TextAreaEmoji =
/*#__PURE__*/
function (_Module) {
  module_textarea_emoji_inherits(TextAreaEmoji, _Module);

  function TextAreaEmoji(quill, options) {
    var _this;

    module_textarea_emoji_classCallCheck(this, TextAreaEmoji);

    _this = module_textarea_emoji_possibleConstructorReturn(this, module_textarea_emoji_getPrototypeOf(TextAreaEmoji).call(this, quill, options));
    _this.quill = quill;
    ...
    _this.container.addEventListener('click', _this.checkEmojiBoxExist.bind(module_textarea_emoji_assertThisInitialized(_this)), false);

    return _this;
  }

  module_textarea_emoji_createClass(TextAreaEmoji, [{
      ...
      if (elementExists) {
        ...
        emojiType.map(function (emojiType) {
          ...
          emojiFilter.addEventListener('click', function () {
            ...
            var type = emojiFilter.dataset.filter;
            module_textarea_emoji_fn_emojiElementsToPanel(type, panel, innerQuill);
          });
        });
        var windowHeight = window.innerHeight;
        var editorPos = this.quill.container.getBoundingClientRect().top;
        ...
        module_textarea_emoji_fn_emojiPanelInit(panel, this.quill);
      }
    }
  }]);

  return TextAreaEmoji;
}(module_textarea_emoji_Module);

TextAreaEmoji.DEFAULTS = {
  buttonIcon: '<svg viewbox="0 0 18 18"><circle class="ql-fill" cx="7" cy="7" r="1"></circle><circle class="ql-fill" cx="11" cy="7" r="1"></circle><path class="ql-stroke" d="M7,10a2,2,0,0,0,4,0H7Z"></path><circle class="ql-stroke" cx="9" cy="9" r="6"></circle></svg>'
};

function module_textarea_emoji_fn_close() {
...
function module_textarea_emoji_fn_updateRange(quill) {
  var range = quill.getSelection();
  return range;
}

function module_textarea_emoji_fn_emojiPanelInit(panel, quill) {
  module_textarea_emoji_fn_emojiElementsToPanel('p', panel, quill);
  document.querySelector('.filter-people').classList.add('active');
}

function module_textarea_emoji_fn_emojiElementsToPanel(type, panel, quill) {
  var fuseOptions = {
    shouldSort: true,
    matchAllTokens: true,
    threshold: 0.3,
  ...
  quill.focus();
  var range = module_textarea_emoji_fn_updateRange(quill);
  result.map(function (emoji) {
    var span = document.createElement('span');
    var t = document.createTextNode(emoji.shortname);
    span.appendChild(t);
...
/* harmony default export */ var module_textarea_emoji = (TextAreaEmoji);
// EXTERNAL MODULE: ./src/scss/quill-emoji.scss
var quill_emoji = __webpack_require__(2);
...
external_commonjs_quill_commonjs2_quill_amd_quill_root_Quill_default.a.register({
  'formats/emoji': format_emoji_blot,
  'modules/emoji-shortname': module_emoji,
  'modules/emoji-toolbar': module_toolbar_emoji,
  'modules/emoji-textarea': module_textarea_emoji
}, true);
/* harmony default export */ var src_quill_emoji = __webpack_exports__["default"] = ({
  EmojiBlot: format_emoji_blot,
  ShortNameEmoji: module_emoji,
  ToolbarEmoji: module_toolbar_emoji,
  TextAreaEmoji: module_textarea_emoji
});
